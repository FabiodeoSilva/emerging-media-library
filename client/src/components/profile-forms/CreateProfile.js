    ...
    <Fragment>
      ...
      <form className='form' onSubmit={e => onSubmit(e)}>
        <div className='form-group'>
          <select name='interests' value={interests} onChange={e => onChange(e)}>
            <option value='0'>* Select interest within the Emerging Media field</option>
        ...
        <div className='form-group'>
          ...
          />
          <small className='form-text'>
            Please use comma separated values (eg. Photoshop, Illustrator, Unity, HTML, CSS, JavaScript, etc.)
          </small>
        </div>
        <div className='form-group'>
          <textarea
